    ...
    const loginUser = async () => {
      ...
      try {
        const response = await fetch(
          `${API_URL}/api/Login?username=${encodeURIComponent(
            loginData.username,
      ...
      {!otpShow ? (
        <View style={styles.loaderContainer}>
          <Animated.View
            ...
            <Image style={styles.logo} source={require('../images/as.png')} />
          </Animated.View>
        ...
        <View style={styles.otpContainer}>
          <Image style={styles.otpLogo} source={require('../images/as.png')} />
